                ...
                <div className="relative group">
                    ...
                    >
                        {otherProjects.map((p, i) => (
                            ...
                            >
                                {/* Background Layer */}
                                {(p.image || p.galleryImages?.[0]) ? (
                                    <img src={p.image || p.galleryImages?.[0]} alt={p.title} loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                                ) : (
