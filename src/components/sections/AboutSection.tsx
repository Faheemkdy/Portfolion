...
const GALLERY_IMAGES = [
    ...
    "/assets/erp-2.png",
    "/assets/erp-3.png",
    "/assets/lapfix-home.png",
    "/assets/lapfix-booking.png",
    "/assets/md-billing.png",
    "/assets/md-dashboard.png",
    "/assets/pcfix-landing.png",
    "/assets/pcfix-admin.png",
                ...
                <div className="relative z-10">
                    ...
                    >
                        <h2 className="text-[32px] sm:text-[48px] md:text-[64px] lg:text-[76px] xl:text-[88px] font-bold tracking-tight leading-[0.92] text-zinc-900 dark:text-white transition-colors">
                            ...
                            Building <span className="text-zinc-400 dark:text-zinc-500 font-medium">Reliable Software</span> <br className="hidden md:block" />
                            <span className="text-zinc-900 dark:text-white">and</span> IT <span className="font-serif italic font-normal text-zinc-900 dark:text-white lowercase opacity-90">Infrastructure</span>
            ...
            <div className="relative pointer-events-none mt-[20vh] md:mt-[20vh]">
                ...
                <div className="bg-background dark:bg-black transition-colors duration-500 pointer-events-auto relative">
                    ...
                    <div className="-mt-[50vh] flex flex-col items-center w-full bg-background relative z-20 pt-32 pb-32">
                        ...
                        {/* Certificate Showcase Section Removed */}

                        {/* Stacking Card Showcases Removed */}
                    </div>
                    <AuditFunnel />
                </div>
            </div>
