      ...
      <main className="relative flex-1 flex flex-col justify-center pt-28 md:pt-40 pb-20 z-10">
        <div className="flex relative gap-4 px-4 md:px-6 md:items-center w-full flex-col justify-center overflow-x-hidden">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Hi, I'm {personal.name}.<br />PHP Developer & Technical Support Engineer with 5+ years of experience.
            </motion.p>
          ...
          <div className="md:flex gap-8 items-center relative">
            <div className="relative">
              ...
              >
                ...
                <div ref={zapSmallRef} className="block lg:hidden mx-[0.05em]">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Available for PHP Development, System Administration & Technical Support Roles.
            </motion.p>
          </div>
        </div>
          ...
          <AnimatePresence>
            {showProfile && (
              ...
              >
                <ProfileCard
                  name={personal.name}
                  title="PHP Developer & Backend Engineer"
                  description={`${personal.name} is a PHP Developer and Backend Engineer with expertise in Laravel, MySQL, and system administration. He bridges the gap between software and hardware — building enterprise-grade web applications and managing IT infrastructure.`}
