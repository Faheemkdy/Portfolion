...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/assets/php-dev.png', alt: 'PHP Developer' },
            { src: '/assets/tech.png', alt: 'System Technician' },
            { src: '/assets/education.png', alt: 'Education' },
            { src: '/assets/erp-1.png', alt: 'ERP System' },
            { src: '/assets/erp-2.png', alt: 'ERP Report' },
            { src: '/assets/erp-3.png', alt: 'ERP Invoice' },
            { src: '/assets/lapfix-home.png', alt: 'LapFix Home' },
            { src: '/assets/lapfix-booking.png', alt: 'LapFix Booking' },
            { src: '/assets/md-billing.png', alt: 'MD Logistics Billing' },
            { src: '/assets/md-dashboard.png', alt: 'MD Dashboard' },
            { src: '/assets/pcfix-landing.png', alt: 'PCFIX Landing' },
            { src: '/assets/pcfix-admin.png', alt: 'PCFIX Admin' },
            { src: '/assets/pcfix-tracker.png', alt: 'PCFIX Tracker' },
            { src: '/assets/logistics.png', alt: 'Logistics' },
        ];
