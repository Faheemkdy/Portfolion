...
const CATEGORIES = [
  {
    ...
    fullTitle: "PHP DEVELOPMENT",
    description: "Building secure web applications using PHP and CodeIgniter.",
  ...
  //   description: "Responsive interfaces using HTML, CSS, Bootstrap and JavaScript.",
  //   filterCategories: ['software']
  // },
  {
    id: "02",
    title: "System Support",
    fullTitle: "SYSTEM SUPPORT",
    description: "Hardware troubleshooting, OS installation and network maintenance.",
    filterCategories: ['devops', 'other']
  }
];
