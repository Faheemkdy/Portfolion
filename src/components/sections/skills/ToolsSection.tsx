...
const toolLogos: Record<string, string> = {
    ...
    'Antigravity': 'https://cdn.simpleicons.org/googlegemini/white'
};
...
const ToolPill = ({ tool }: { tool: any }) => {
    const iconUrl = toolLogos[tool.name] || (tool.icon.startsWith('http') ? tool.icon : `https://cdn.simpleicons.org/${tool.icon}`);
