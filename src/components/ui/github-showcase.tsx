...
const PINNED_REPOS = [
  {
    ...
    desc: "Comprehensive customization of an existing enterprise ERP system. Developed new business modules and optimized backend logic using PHP and MySQL.",
    stars: 4,
    forks: 2,
    lang: "PHP",
    url: "#"
  ...
  {
    name: "LapFix-AI",
    desc: "AI-powered laptop diagnostic marketplace connecting users with verified technicians. Smart hardware scanning, slot-based booking, and automated reports.",
    stars: 6,
    forks: 3,
    lang: "Dart",
    url: "#"
  ...
  {
    name: "MD-Logistics-Billing",
    desc: "Full-scale billing and invoice management system with real-time calculations and automated PDF generation for logistics operations.",
    stars: 5,
    forks: 1,
    lang: "JavaScript",
    url: "https://mdlogistics-six.vercel.app/login"
  },
  {
    name: "PCFIX-Platform",
    desc: "High-performance service management platform with immersive 3D landing page, real-time repair tracking, and robust admin ecosystem.",
    stars: 8,
    forks: 4,
    lang: "TypeScript",
    url: "https://pc-fix-five.vercel.app/"
  }
];
