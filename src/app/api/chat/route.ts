...
## Education
${eduList || 'BSc. Computer Science, Calicut University.'}

## Technical Skills
${skillList || 'PHP, Laravel, MySQL, React, JavaScript, Flutter.'}

## Soft Skills
${softSkillList || 'Leadership, Communication, Problem Solving.'}

## Tools & Technologies
${toolList || 'VS Code, Git, Android Studio.'}

## Achievements & Certifications
${achievementList || 'See portfolio for details.'}

## Instructions
- Answer in ${locale === 'id' ? 'English' : 'English'} (the current interface language). However, if the user asks in a different language, feel free to respond in that language too, while maintaining a professionally friendly tone.
