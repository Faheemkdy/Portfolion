...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const updatedProject = {
        ...project,
        image: galleryImages.length > 0 ? galleryImages[0] : (project.image || (project.galleryImages && project.galleryImages.length > 0 ? project.galleryImages[0] : undefined)), // First image as Hero
