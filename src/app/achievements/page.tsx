                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        >
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-3">
                                Professional Skills<br />& Certifications
                            </h2>
                            <p className="text-sm text-muted-foreground/60 max-w-lg mx-auto leading-relaxed">
                                Certifications, technical skills, and professional expertise gained through education and hands-on experience.
                            </p>
                        </motion.div>
                        ...
                        >
                            <ErrorBoundary fallback={<div className="text-center opacity-50">Visuals Unavailable</div>}>
                                <FallingText
                                    text="PHP CodeIgniter MySQL HTML CSS JavaScript Bootstrap Windows Linux Hardware Diagnostics Desktop Support Laptop Repair Technical System Administration Networking Server Maintenance Database Management Troubleshooting IT Infrastructure"
                                    highlightWords={['PHP', 'CodeIgniter', 'Hardware', 'Networking', 'Server', 'IT']}
                                    trigger="scroll"
                                    gravity={0.8}
